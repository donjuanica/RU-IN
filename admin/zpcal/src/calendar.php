...
class DHTML_Calendar {
    ...
    function _make_calendar($other_options = array()) {
        $js_options = $this->_make_js_hash(array_merge_custom($this->calendar_options, $other_options));
    ...
    function make_input_field($cal_options = array(), $field_attributes = array()) {
        $id = $this->_gen_id();
        $attrstr = $this->_make_html_attr(array_merge_custom($field_attributes,
        ...
        $options = array_merge_custom($cal_options,
