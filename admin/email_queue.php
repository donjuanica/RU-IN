...
$active_nav = "email_queue";
$admin_site_name = SITE_NAME . " Admin | Email Queue";
$table_to_edit = 'email_queue';
...
$editor->setDefaultOrderby('email_queue_id', 0);
